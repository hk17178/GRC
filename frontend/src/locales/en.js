...
export default {
  ...
  // ---- Change password page (C7 i18n) ----
  changepwd: {
    title: 'Change Login Password',
    forcedSub: 'You must change the initial password before using the system.',
    sub: 'Changing your password periodically helps keep your account secure.',
    oldLabel: 'Current password',
    oldPh: 'Current login password',
    newLabel: 'New password',
    newPh: 'At least 8 chars, not the demo password',
    confirmLabel: 'Confirm new password',
    confirmPh: 'Re-enter the new password',
    okMsg: 'Password updated, entering the system…',
    submit: 'Confirm Change',
    errMin: 'New password must be at least 8 characters',
    errDemo: 'The demo password is not allowed',
    errMismatch: 'The two new passwords do not match'
  },

  // ---- Mobile signature page (C7 i18n) ----
  signpad: {
    brand: 'Handwritten Signature',
    defaultTitle: 'Risk Assessment Sign-off',
    hint: 'Sign in the area below (landscape works best), then tap "Submit Signature".',
    clear: 'Clear',
    submit: 'Submit Signature',
    expLabel: 'Token valid until {t}',
    doneMsg: '✓ Signature submitted',
    doneHint: 'Return to your computer to complete the sign-off. You may close this page.',
    invalidHint: 'Return to your computer and restart "Mobile Signature".',
    errExpired: 'Token expired or unavailable',
    errInvalid: 'Token does not exist or has expired'
  },

  // ---- Internal Audit (InternalAuditView · M3) ----
  intaudit: {
    kqt: 'M3 · Internal Audit',
    title: 'Internal Audit Execution & Management',
    newPlan: '＋ New Audit Plan',
    noWritePerm: 'No audit management write permission',
    kpi: {
    ...
    plan: {
      title: 'Audit Plans',
      th: { id: 'ID', title: 'Topic', type: 'Type', startDate: 'Start Date', status: 'Status', ops: 'Actions' },
      typeInternal: 'Internal Audit',
      opsPlaceholder: 'Actions…',
      opStart: 'Start Audit',
      opReport: 'Issue Report',
      opClose: 'Close Plan',
      opCancel: 'Cancel Plan',
      opBind: 'Bind Checklist',
      opChecklist: 'Run Checklist',
      opFollowup: 'Start Follow-up Audit',
      opGotoChecklist: 'Checklist #{id}',
      opNotice: 'Notice',
      opNoticeIssued: 'Notice (Issued)',
      opDossier: 'Export Dossier',
      followUpTip: 'Follow-up audit: verify effectiveness of the original remediation',
      empty: 'No internal audit plans yet. Click "＋ New Audit Plan".'
    },
    finding: {
      title: 'Findings',
      selectPlan: '— Select an audit plan —',
      newBtn: '＋ New Finding',
      selectFirst: 'Select an audit plan first.',
      th: { id: 'ID', problem: 'Problem', severity: 'Severity', ops: 'Actions' },
      fiveElements: '5 Elements',
      fiveElementsDone: '5 Elements ✓',
      uploadEvidence: 'Upload Evidence',
      issueRemed: 'Issue Remediation',
      empty: 'No findings for this plan yet.'
    },
    remed: {
      title: 'Remediation Tracking',
      selectFinding: '— Select a finding —',
      pickFirst: 'Select a finding in "Findings" first, or choose one here.',
      th: { id: 'ID', assignee: 'Owner', measure: 'Remediation Measure', due: 'Due', status: 'Status', ops: 'Actions' },
      start: 'Start',
      submit: 'Submit',
      verify: 'Verify',
      reject: 'Reject',
      empty: 'No remediation orders for this finding. Issue one from "Findings".'
    },
    annual: {
      title: 'Annual Audit Plan',
      sub: 'Click a row to expand its objects · Rank by risk → Approve & freeze → Convert item by item',
      newBtn: '＋ New Annual Plan',
      th: { year: 'Year', title: 'Title', status: 'Status', approve: 'Approval', ops: 'Actions' },
      approved: 'Approved',
      draft: 'Draft',
      addItem: '＋ Add Object',
      approve: 'Approve',
      collapse: '▲ Collapse',
      expand: '▼ Expand',
      subTh: { riskRank: 'Risk Rank', target: 'Audit Object', quarter: 'Schedule', note: 'Focus Points', plan: 'Converted', ops: 'Actions' },
      notPlanned: 'Not converted',
      toPlan: 'Convert to Plan',
      emptyItems: 'No audit objects yet. Click "＋ Add Object".',
      empty: 'No annual plans yet. Click "＋ New Annual Plan".',
      newTitle: 'New Annual Audit Plan',
      fldYear: 'Plan Year',
      fldTitle: 'Title (optional, defaults to "{year} Annual Internal Audit Plan")',
      fldOrg: 'Organization',
      itemTitle: 'Add Audit Object',
      fldTarget: 'Audit Object (unit/system/process)',
      targetPh: 'e.g. Payment settlement system',
      fldRiskRank: 'Risk Rank (1 = highest)',
      fldQuarter: 'Schedule',
      fldNote: 'Focus Points / Rationale',
      notePh: 'e.g. Reserve funds compliance focus, many findings last year'
    },
    proc: {
      title: 'Audit Procedures / Working Papers',
      sub: 'Execution record is the working paper · Reviewer must differ from executor',
      newBtn: '＋ New Procedure',
      hint: 'After selecting a plan, maintain audit procedures: procedure (what to do / verify) → keep working paper on execution (WP number) → cross review.',
      th: { wpNo: 'WP No.', step: 'Procedure Step', objective: 'Objective', record: 'Execution Record (WP)', executor: 'Executor', reviewer: 'Reviewer', status: 'Status', ops: 'Actions' },
      exec: 'Execute',
      review: 'Review',
      empty: 'No procedures yet. Click "＋ New Procedure" to build the audit procedure list.',
      addTitle: 'New Audit Procedure',
      fldStep: 'Procedure Step (what to do)',
      stepPh: 'e.g. Sample-check whether departed accounts are disabled',
      fldObjective: 'Procedure Objective (what to verify)',
      objectivePh: 'e.g. Verify effectiveness of account recovery controls',
      execTitle: 'Execute Procedure · {wp}',
      execHint: 'The execution record is the working paper and cannot be overwritten after submission (add a new procedure if supplements are needed).',
      fldRecord: 'Execution Record (Working Paper)',
      recordPh: 'What was done, which samples, what was found, where the evidence is…',
      submitRecord: 'Submit Working Paper'
    },
    evidence: {
      title: 'Evidence Library',
      sub: 'SHA-256 fingerprint sealed · Reverse forensics can detect tampering',
      uploadBtn: '＋ Upload Evidence',
      th: { id: 'ID', name: 'Name', file: 'File', linked: 'Linked Objects', fingerprint: 'Fingerprint (first 12 of SHA-256)', upload: 'Uploader', ops: 'Actions' },
      download: 'Download',
      verify: 'Reverse Forensics',
      empty: 'No evidence yet. Click "＋ Upload Evidence" and link to a plan/finding/remediation order.',
      verifyOk: '✓ Integrity check passed',
      verifyBad: '✕ Fingerprint mismatch — the file may have been tampered with!',
      verifyDetail: 'Sealed fingerprint {stored}… · Recomputed {actual}…',
      tracePlan: 'Trace: plan "{title}"',
      traceFinding: 'finding "{title}"',
      uploadTitle: 'Upload Evidence',
      fldName: 'Evidence Name / Description',
      namePh: 'e.g. Firewall policy screenshot',
      defaultName: 'Evidence for finding AF-{id}',
      fldFile: 'File',
      fldPlan: 'Linked Audit Plan',
      fldFinding: 'Linked Finding',
      fldOrg: 'Organization',
      noLink: '— No link —',
      uploading: 'Uploading…',
      upload: 'Upload'
    ...
    report: {
      title: 'Audit Report',
      selectPlan: '— Select an audit plan —',
      tplBtn: 'Report Templates',
      noTpl: 'No template',
      createDraft: 'Generate Report Draft (auto-compose)',
      saving: 'Saving…',
      save: 'Save',
      comment: 'Request Comments',
      finalize: 'Finalize',
      issue: 'Issue',
      hint: 'Select an audit plan: with no report, auto-compose in one click (plan + finding 5 elements + remediation ledger), then Request Comments → Finalize (select audit opinion) → Issue.',
      fldTitle: 'Report Title',
      fldOpinion: 'Audit Opinion (required to finalize)',
      opinionUndecided: '— Undecided —',
      opinionSatisfactory: 'Satisfactory',
      opinionGenerally: 'Generally Satisfactory',
      opinionNeedsImprovement: 'Needs Improvement',
      opinionUnsatisfactory: 'Unsatisfactory',
      fldSummary: 'Audit Overview & Overall Evaluation',
      fldContent: 'Report Body (auto-composed, editable)',
      exportDocx: 'Export Report .docx',
      issued: '✓ Issued · {by} · {at} (body frozen)',
      noReport: 'No report for this plan yet — click "Generate Report Draft" at the top right.'
    },
    rptTpl: {
      title: 'Audit Report Templates',
      desc: 'Selected as the body skeleton when generating a draft; the system-composed content (finding 5 elements / remediation ledger) follows as an appendix. Includes a built-in template for the "Personal Information Protection Compliance Audit Management Measures" (effective 2025-05-01).',
      collapse: 'Collapse',
      edit: 'Edit',
      disable: 'Disable',
      enable: 'Enable',
      del: 'Del',
      saveContent: 'Save Body',
      newNamePh: 'New template name',
      categoryPh: 'Category (e.g. MLPS)',
      addBtn: 'Create Template',
      close: 'Close',
      confirmDel: 'Delete template "{name}"?'
    },
    notice: {
      title: 'Audit Notice · AP-{id}',
      issued: '✓ Issued · {by} · {at} (content frozen)',
      fldAuditee: 'Audited Unit / Department',
      fldScope: 'Audit Scope',
      fldBasis: 'Audit Basis',
      basisPh: 'e.g. Item 3 of the 2026 annual internal audit plan',
      fldTeam: 'Audit Team Members (lead first)',
      exportDocx: 'Export Notice .docx',
      close: 'Close',
      saveDraft: 'Save Draft',
      issueBtn: 'Issue Notice'
    },
    detail: {
      title: 'Finding 5 Elements · AF-{id}',
      condition: 'Condition (objective facts)',
      criteria: 'Criteria (policies/regulations to follow)',
      cause: 'Cause',
      effect: 'Effect (risks & consequences)',
      recommendation: 'Recommendation',
      mgmtResponse: 'Management Response',
      responsePh: 'Audited unit comments / remediation commitment…',
      submitResponse: 'Submit Response',
      close: 'Close',
      saving: 'Saving…',
      saveElements: 'Save 5 Elements'
    },
    bind: {
      title: 'Bind Checklist Template',
      hint: 'AP-{id} · {title} (the template must already have a docx form uploaded on the Risk Assessment page)',
      fldTpl: 'Assessment Template',
      selectTpl: '— Select a template —',
      confirmBind: 'Confirm Binding'
    },
    planForm: {
      title: 'New Audit Plan',
      fldTopic: 'Audit Topic',
      topicPh: 'e.g. Payment system security audit',
      fldStartDate: 'Planned Start Date',
      fldOrg: 'Organization'
    },
    findingForm: {
      title: 'New Audit Finding',
      fldProblem: 'Problem Description',
      problemPh: 'e.g. Access control policy does not enforce least privilege',
      fldSeverity: 'Severity',
      fldCriteria: 'Audit Basis / Clause',
      criteriaPh: 'e.g. Information Security Policy §4.2 Least Privilege / MLPS 2.0 8.1.4'
    },
    remedForm: {
      title: 'Issue Remediation Order',
      hint: 'For finding AF-{id}: {title}',
      fldAssignee: 'Owner',
      assigneePh: 'e.g. John Doe',
      fldMeasure: 'Remediation Measure',
      measurePh: 'e.g. Configure least-privilege policy and review',
      fldDue: 'Due Date'
    },
    note: 'Checklist execution reuses the same .docx form engine as Risk Assessment: on a plan, "Bind Checklist" (select an assessment template) → "Run Checklist" to generate an assessment → fill in / export on the Risk Assessment page.',
    msg: {
      planStart: 'Started',
      planReport: 'Report issued',
      planClose: 'Closed',
      planCancel: 'Cancelled',
      checklistGen: 'Checklist assessment #{id} generated. Fill it in on the Risk Assessment page.',
      followupDone: 'Follow-up audit AP-{id} started'
    },
    sev: { VERY_LOW: 'Very Low', LOW: 'Low', MID: 'Medium', HIGH: 'High' },
    planStatus: { PLANNED: 'Planned', IN_PROGRESS: 'In Progress', REPORTING: 'Pending Sign-off', CLOSED: 'Closed', CANCELLED: 'Cancelled' },
    remStatus: { PENDING: 'Pending', IN_PROGRESS: 'In Remediation', SUBMITTED: 'Submitted', VERIFIED: 'Verified', REJECTED: 'Rejected' },
    procStatus: { PENDING: 'Pending', DONE: 'Executed', REVIEWED: 'Reviewed' },
    rptStatus: { DRAFT: 'Draft', COMMENTING: 'Under Comment', FINAL: 'Finalized', ISSUED: 'Issued' }
  },
