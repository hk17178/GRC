...
export default {
  ...
  changepwd: {
    title: '修改登录口令',
    forcedSub: '首次登录须修改初始口令后方可使用系统。',
    sub: '定期更换口令有助于账号安全。',
    oldLabel: '原口令',
    oldPh: '当前登录口令',
    newLabel: '新口令',
    newPh: '至少 8 位，不得为演示口令',
    confirmLabel: '确认新口令',
    confirmPh: '再次输入新口令',
    okMsg: '口令已更新，正在进入系统…',
    submit: '确认修改',
  ...
  signpad: {
    brand: '手写签名',
    defaultTitle: '风险评估签批',
    hint: '请在下方区域手写签名（横屏体验更佳），完成后点「提交签名」。',
    clear: '清除',
    submit: '提交签名',
    expLabel: '令牌有效期至 {t}',
    doneMsg: '✓ 签名已提交',
    doneHint: '请回到电脑端完成签批，本页可关闭。',
    invalidHint: '请回到电脑端重新发起「手机签名」。',
    errExpired: '令牌已过期或不可用',
    errInvalid: '令牌不存在或已失效'
  },

  // ---- 内部审计（InternalAuditView · M3）----
  intaudit: {
    kqt: 'M3 · 内部审计',
    title: '内部审计实施与管理',
    newPlan: '＋ 新建审计计划',
    noWritePerm: '无审计管理写权限',
    kpi: {
      plans: '内审计划',
      inProgress: '实施中',
      findings: '审计发现',
    ...
    plan: {
      title: '审计计划',
      th: { id: '编号', title: '主题', type: '类型', startDate: '开始日', status: '状态', ops: '操作' },
      typeInternal: '内部审计',
      opsPlaceholder: '操作…',
      opStart: '开始审计',
      opReport: '出具报告',
      ...
      opChecklist: '执行检查表',
      opFollowup: '发起后续审计',
      opGotoChecklist: '检查表 #{id}',
      opNotice: '通知书',
      opNoticeIssued: '通知书（已签发）',
      opDossier: '卷宗导出',
      followUpTip: '后续审计：验证原计划整改有效性',
      empty: '暂无内审计划，点「＋ 新建审计计划」。'
    },
    finding: {
      title: '审计发现',
      selectPlan: '— 选择审计计划 —',
      newBtn: '＋ 新建发现',
      selectFirst: '先选择一个审计计划。',
      th: { id: '编号', problem: '问题', severity: '严重度', ops: '操作' },
      fiveElements: '五要素',
      fiveElementsDone: '五要素 ✓',
      uploadEvidence: '上传证据',
      issueRemed: '下达整改',
      empty: '该计划暂无审计发现。'
    },
    remed: {
      title: '整改跟踪',
      selectFinding: '— 选择审计发现 —',
      pickFirst: '先在「审计发现」选一条发现，或在此选择。',
      th: { id: '编号', assignee: '责任人', measure: '整改措施', due: '截止', status: '状态', ops: '操作' },
      start: '开始',
      submit: '提交',
      verify: '验证通过',
      reject: '驳回',
      empty: '该发现暂无整改单，去「审计发现」下达整改。'
    },
    annual: {
      title: '年度审计计划',
      sub: '点行展开对象清单 · 风险排序 → 批准冻结 → 逐项立项',
      newBtn: '＋ 新建年度计划',
      th: { year: '年度', title: '标题', status: '状态', approve: '批准', ops: '操作' },
      approved: '已批准',
      draft: '草稿',
      addItem: '＋ 纳入对象',
      approve: '批准',
      collapse: '▲ 收起',
      expand: '▼ 展开',
      subTh: { riskRank: '风险序', target: '审计对象', quarter: '排期', note: '关注要点', plan: '立项', ops: '操作' },
      notPlanned: '未立项',
      toPlan: '转审计计划',
      emptyItems: '暂无审计对象，点「＋ 纳入对象」。',
      empty: '暂无年度计划，点「＋ 新建年度计划」。',
      newTitle: '新建年度审计计划',
      fldYear: '计划年度',
      fldTitle: '标题（可空，默认「{year} 年度内部审计计划」）',
      fldOrg: '所属组织',
      itemTitle: '纳入审计对象',
      fldTarget: '审计对象（单位/系统/流程）',
      targetPh: '如 支付结算系统',
      fldRiskRank: '风险排序（1 最高）',
      fldQuarter: '排期',
      fldNote: '关注要点/理由',
      notePh: '如 备付金合规重点、上年发现较多'
    },
    proc: {
      title: '审计程序 / 工作底稿',
      sub: '执行记录即底稿 · 复核人须≠执行人',
      newBtn: '＋ 新增程序',
      hint: '选择计划后维护审计程序：程序（做什么/验证什么）→ 执行留工作底稿（WP 编号）→ 交叉复核。',
      th: { wpNo: '底稿号', step: '程序步骤', objective: '目标', record: '执行记录（底稿）', executor: '执行', reviewer: '复核', status: '状态', ops: '操作' },
      exec: '执行',
      review: '复核',
      empty: '暂无程序，点「＋ 新增程序」建立审计程序表。',
      addTitle: '新增审计程序',
      fldStep: '程序步骤（做什么）',
      stepPh: '如 抽样核验离职账号禁用情况',
      fldObjective: '程序目标（验证什么）',
      objectivePh: '如 验证账号回收控制有效性',
      execTitle: '执行程序 · {wp}',
      execHint: '执行记录即工作底稿，提交后不可覆盖（如需补充另立程序）。',
      fldRecord: '执行记录（工作底稿）',
      recordPh: '做了什么、抽了哪些样本、发现了什么、证据在哪…',
      submitRecord: '提交底稿'
    },
    evidence: {
      title: '证据库',
      sub: 'SHA-256 指纹固化 · 反向取证可校验篡改',
      uploadBtn: '＋ 上传证据',
      th: { id: '编号', name: '名称', file: '文件', linked: '关联对象', fingerprint: '指纹（SHA-256 前 12 位）', upload: '上传', ops: '操作' },
      download: '下载',
      verify: '反向取证',
      empty: '暂无证据，点「＋ 上传证据」并关联 计划/发现/整改单。',
      verifyOk: '✓ 完整性校验通过',
      verifyBad: '✕ 指纹不一致——文件可能被篡改！',
      verifyDetail: '固化指纹 {stored}… · 现算 {actual}…',
      tracePlan: '回溯：计划「{title}」',
      traceFinding: '发现「{title}」',
      uploadTitle: '上传证据',
      fldName: '证据名称/说明',
      namePh: '如 防火墙策略截图',
      defaultName: '发现 AF-{id} 证据',
      fldFile: '文件',
      fldPlan: '关联审计计划',
      fldFinding: '关联审计发现',
      fldOrg: '所属组织',
    ...
    report: {
      ...
      tplBtn: '报告模板',
      noTpl: '不使用模板',
      createDraft: '生成报告草稿（自动组稿）',
      saving: '保存中…',
      save: '保存',
      comment: '征求意见',
      finalize: '定稿',
      issue: '签发',
      hint: '选择一个审计计划：无报告可一键自动组稿（计划+发现五要素+整改台账），再走 征求意见 → 定稿（选审计意见）→ 签发。',
      fldTitle: '报告标题',
      fldOpinion: '审计意见（定稿必选）',
      opinionUndecided: '— 未定 —',
      opinionSatisfactory: '满意',
      opinionGenerally: '基本满意',
      opinionNeedsImprovement: '需改进',
      opinionUnsatisfactory: '不满意',
      fldSummary: '审计概述与总体评价',
      fldContent: '报告正文（自动组稿，可编辑）',
      exportDocx: '导出报告 .docx',
      issued: '✓ 已签发 · {by} · {at}（正文已冻结）',
      noReport: '该计划暂无报告——点右上「生成报告草稿」。'
    },
    rptTpl: {
      title: '审计报告模板',
      desc: '生成草稿时选用作正文骨架，系统组稿（发现五要素/整改台账）作为附录随后。内置含《个人信息保护合规审计管理办法》（2025-05-01 施行）模板。',
      collapse: '收起',
      edit: '编辑',
      disable: '停用',
      enable: '启用',
      ...
      addBtn: '新建模板',
      close: '关闭',
      confirmDel: '确认删除模板「{name}」？'
    },
    notice: {
      title: '审计通知书 · AP-{id}',
      issued: '✓ 已签发 · {by} · {at}（内容已冻结）',
      fldAuditee: '被审计单位/部门',
      fldScope: '审计范围',
      fldBasis: '审计依据',
      basisPh: '如 2026 年度内审计划第 3 项',
      fldTeam: '审计组成员（组长在前）',
      exportDocx: '导出通知书 .docx',
      close: '关闭',
      saveDraft: '保存草稿',
      issueBtn: '签发通知书'
    },
    detail: {
      title: '发现五要素 · AF-{id}',
      condition: '现状（condition：客观事实）',
      criteria: '标准（criteria：应遵循的制度/法规）',
      cause: '原因（cause）',
      effect: '影响（effect：风险与后果）',
      recommendation: '建议（recommendation）',
      mgmtResponse: '管理层回应',
      responsePh: '被审计单位意见 / 整改承诺…',
      submitResponse: '提交回应',
      close: '关闭',
      saving: '保存中…',
      saveElements: '保存五要素'
    ...
    bind: {
      title: '绑定检查表模板',
      hint: 'AP-{id} · {title}（模板须已在风险评估页上传 docx 表单）',
      fldTpl: '评估模板',
      selectTpl: '— 选择模板 —',
      confirmBind: '确认绑定'
    },
    ...
    findingForm: {
      title: '新建审计发现',
      fldProblem: '问题描述',
      problemPh: '如 访问控制策略未落实最小授权',
      fldSeverity: '严重度',
      fldCriteria: '审计依据/条款',
      criteriaPh: '如 信息安全管理制度 §4.2 最小授权 / 等保2.0 8.1.4'
    },
    remedForm: {
      title: '下达整改单',
      hint: '针对发现 AF-{id}：{title}',
      fldAssignee: '责任人',
      assigneePh: '如 张三',
      fldMeasure: '整改措施',
      measurePh: '如 配置最小授权策略并复核',
      fldDue: '截止日期'
    },
    note: '检查表执行复用风险评估同一套 .docx 表单引擎：在计划上「绑定检查表」（选评估模板）→「执行检查表」生成评估 → 到风险评估页填写/导出。',
    msg: {
      planStart: '已开始',
      planReport: '已出具报告',
      planClose: '已关闭',
      planCancel: '已取消',
      checklistGen: '已生成检查表评估 #{id}，到风险评估页填写',
      followupDone: '已发起后续审计 AP-{id}'
    },
    sev: { VERY_LOW: '极低', LOW: '低', MID: '中', HIGH: '高' },
    planStatus: { PLANNED: '已计划', IN_PROGRESS: '实施中', REPORTING: '待签批', CLOSED: '已关闭', CANCELLED: '已取消' },
    remStatus: { PENDING: '待开始', IN_PROGRESS: '整改中', SUBMITTED: '已提交', VERIFIED: '已验证', REJECTED: '已驳回' },
    procStatus: { PENDING: '待执行', DONE: '已执行', REVIEWED: '已复核' },
    rptStatus: { DRAFT: '草稿', COMMENTING: '征求意见中', FINAL: '已定稿', ISSUED: '已签发' }
  },
